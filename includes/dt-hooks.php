...
function custom_fields( array $fields, string $post_type = "" ){
    if ( $post_type === "contacts" ) {
        ...
        if ( isset( $fields["quick_button_no_answer"] ) ) {
            $fields["quick_button_no_answer"]["short_name"] = __( 'No Answer', 'roles_plugin' );
        ...
        if ( isset( $fields["quick_button_contact_established"] ) ){
            $fields["quick_button_contact_established"]["short_name"] = __( 'Talked', 'roles_plugin' );
        ...
        if ( isset( $fields["quick_button_meeting_scheduled"] ) ){
            $fields["quick_button_meeting_scheduled"]["short_name"] = __( 'Scheduled', 'roles_plugin' );
        ...
        if ( isset( $fields["quick_button_meeting_complete"] ) ){
            $fields["quick_button_meeting_complete"]["short_name"] = __( 'Complete', 'roles_plugin' );
        ...
        if ( isset( $fields["quick_button_no_show"] ) ){
            $fields["quick_button_no_show"]["short_name"] = __( 'No-Show', 'roles_plugin' );
...
//            'name'        => __( 'Sent Message', 'roles_plugin' ),
//            'type'        => 'number',
//            'default'     => 0,
